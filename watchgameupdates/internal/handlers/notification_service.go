...
// SendExpectedGoalsNotification is a legacy convenience function for backward compatibility
func SendExpectedGoalsNotification(homeTeam, awayTeam, homeExpectedGoals, awayExpectedGoals string) {
	...
	if notifier == nil {
		// No token configured, skip notification
		return
	}
