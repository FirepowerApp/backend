...
func TestDiscordNotifier_FormatMessage(t *testing.T) {
	testCases := []formatMessageTestCase{
		...
		},
		{
			...
			homeShootOutGoals:      "2",
			awayShootOutGoals:      "1",
			expectedScore:          "CHI 3 - 2 DET", // Home gets +1 for shootout win
			expectedHomeXG:         "CHI: 2.1",
			expectedAwayXG:         "DET: 2.3",
			shouldContainScore:     true,
			shouldContainXG:        true,
			shouldContainTimestamp: true,
		},
		{
			...
			homeShootOutGoals:      "1",
			awayShootOutGoals:      "3",
			expectedScore:          "CHI 2 - 3 DET", // Away gets +1 for shootout win
			expectedHomeXG:         "CHI: 2.1",
			expectedAwayXG:         "DET: 2.3",
			shouldContainScore:     true,
			shouldContainXG:        true,
		...
		},
		{
			...
			homeShootOutGoals:      "1",
			awayShootOutGoals:      "1",
			expectedScore:          "CHI 3 - 3 DET", // No change for tied shootout
			expectedHomeXG:         "CHI: 2.8",
			expectedAwayXG:         "DET: 2.9",
			shouldContainScore:     true,
			shouldContainXG:        true,
			shouldContainTimestamp: true,
		},
